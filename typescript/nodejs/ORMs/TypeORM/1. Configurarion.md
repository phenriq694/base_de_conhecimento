...
1. Install the dependency and database driver. In the example below, postgres driver it been used:
```
yarn add typeorm pg
```
...
```
3. Create a folder in 'src/' called 'database' within a file called 'index.ts':
```typescript
